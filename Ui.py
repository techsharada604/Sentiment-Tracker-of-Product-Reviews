...
os.environ['KAGGLE_USERNAME'] = 'techsharada'
os.environ['KAGGLE_KEY'] = '14c7373244f5d0fcd0f9fdda4c811de8'
...
# Kaggle dataset slug
dataset_slug = "techsharada/output"

# Map categories to filenames
category_files = {
    "Beauty": "output61.csv",
    "Appliances": "output51.csv",
    "Fashion": "output72.csv",
    "Sports Equipment": "output93.csv"
}
...
def load_data(filename):
    ...
    if not os.path.exists(local_file_path):
        api.dataset_download_file(dataset_slug, filename, path=output_dir, force=True)
