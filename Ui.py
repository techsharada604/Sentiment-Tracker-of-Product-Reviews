...
def load_dataset(pth):
    ...
    return df
category_files = {
    "Beauty": r"C:\Users\sharada.pandit\OneDrive - Accenture\Desktop\Proj\New\output61.csv",
    "Appliances": r"C:\Users\sharada.pandit\OneDrive - Accenture\Desktop\Proj\New\output51.csv",
    "Fashion": r"C:\Users\sharada.pandit\OneDrive - Accenture\Desktop\Proj\New\output72.csv",
    "Sports Equipment": r"C:\Users\sharada.pandit\OneDrive - Accenture\Desktop\Proj\New\output92.csv"
}
...
category = st.sidebar.selectbox("Choose a category", list(category_files.keys()))
@st.cache_data
def load_data(file_path):
    return pd.read_csv(file_path)

df = load_data(category_files[category])
